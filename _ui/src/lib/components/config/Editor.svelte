...
<div class="flex flex-col h-full bg-[#1e1e1e]">
 ...
 <ArrowRightLeft size={11} class="text-gray-600 dark:text-slate-300" />
 ...
 {!isHexMode ? 'bg-[#3c3c3c] text-gray-200' : 'bg-transparent text-gray-500 dark:text-slate-400 hover:bg-[#333] hover:text-gray-300'}"
 ...
 {fullyMasked ? 'text-amber-400 hover:bg-[#333] hover:text-amber-300' : 'text-gray-400 dark:text-slate-500 hover:bg-[#333] hover:text-gray-200'}"
 onclick={toggleMask}
