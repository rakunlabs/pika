...
<div class="flex items-stretch bg-slate-100 border-b border-slate-200 min-h-[35px] overflow-hidden">
  ...
  {:else}
    ...
    <!-- Close All button -->
    <button
      class="flex items-center justify-center px-2 shrink-0 text-gray-400 bg-transparent border-none border-l border-slate-200 cursor-pointer transition-colors hover:text-red-500 hover:bg-slate-200"
  ...
  >
    ...
    <button
      class="flex items-center w-full px-3 py-1.5 text-left bg-transparent border-none cursor-pointer transition-colors
        {hasMultipleTabs ? 'text-slate-700 hover:bg-slate-100' : 'text-slate-300 cursor-default'}"
    ...
    <button
      class="flex items-center w-full px-3 py-1.5 text-left bg-transparent border-none cursor-pointer transition-colors
        {hasTabsToRight ? 'text-slate-700 hover:bg-slate-100' : 'text-slate-300 cursor-default'}"
    ...
    <button
      class="flex items-center w-full px-3 py-1.5 text-left bg-transparent border-none cursor-pointer transition-colors
        {hasTabsToLeft ? 'text-slate-700 hover:bg-slate-100' : 'text-slate-300 cursor-default'}"
