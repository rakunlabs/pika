...
<div>
 ...
 <p class="text-sm text-slate-500 dark:text-slate-400 mt-0.5">Build and source information for this pika instance</p>
 </div>
 ...
 <dd class="flex-1 text-sm text-slate-800 dark:text-slate-100">{info?.name ?? "pika"}</dd>
 </div>
