...
<div>
 <div class="mb-4">
 <h2 class="text-lg font-semibold text-slate-800 dark:text-slate-100">Admin Secret</h2>
 <p class="text-sm text-slate-500 dark:text-slate-400 mt-0.5">Set or update the admin secret used to authorize key rotation</p>
 </div>
 ...
 {#if adminSecretConfigured}
 <div class="mb-4">
 <label for="current-admin-secret" class="block text-xs font-medium text-slate-500 dark:text-slate-400 mb-1.5">Current Secret</label>
 <div class="relative">
 <input
 ...
 <div class="mb-4">
 <label for="new-admin-secret" class="block text-xs font-medium text-slate-500 dark:text-slate-400 mb-1.5">New Secret</label>
 <div class="relative">
 <input
 id="new-admin-secret"
 ...
 <div class="mb-4">
 <label for="confirm-admin-secret" class="block text-xs font-medium text-slate-500 dark:text-slate-400 mb-1.5">Confirm New Secret</label>
 <div class="relative">
 <input
